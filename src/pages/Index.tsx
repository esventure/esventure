          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            transition: {
              ...
              <Card className="h-full p-8 border-4 border-primary bg-card shadow-xl hover:shadow-2xl transition-all hover:border-secondary group flex flex-col">
                ...
                <p className="text-lg text-foreground/70 mb-8 font-medium text-justify min-h-[8rem]">When a project or deliverable gets stuck, I take it over and finish it. Slipping deadlines, half-done deliverables, messy ownership, I bring order, clarity, and results. No chaos, just progress.<strong className="text-foreground">take it over</strong> and <strong className="text-foreground">finish it</strong>. Slipping deadlines, half-done deliverables, messy ownership — I bring <strong className="text-foreground">order</strong>, <strong className="text-foreground">clarity</strong>, and <strong className="text-foreground">results</strong>. No chaos, just <strong className="text-foreground">progress</strong>.</p>
