...
const ProjectPlanner = () => {
  ...
  return (
    <section id="project-planner" className="section-pad bg-surface-warm text-surface-warm-foreground pb-[calc(1rem+env(safe-area-inset-bottom))]">
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-5xl mx-auto">
          <div className="mb-8 md:mb-12 text-center">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-black text-foreground mb-3 font-display">
              {t("planner.title")}
            </h2>
