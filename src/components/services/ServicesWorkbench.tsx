...
const ServicesWorkbench = ({ onCta }: Props) => {
  ...
  return (
    <section className="relative overflow-hidden bg-section-yellow text-section-yellow-foreground section-pad">
      {/* Sparkle texture: purple glow over the yellow field */}
      <div
      ...
      >
        ...
        <div className="absolute -bottom-1/2 -left-1/2 h-full w-full rounded-full bg-primary/15 blur-3xl opacity-40" />
      </div>
      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="border-t border-section-yellow-foreground/20">
            {services.map((s, i) => (
              <motion.div
                key={i}
                initial={{ opacity: 0, y: 20 }}
                ...
                className="group relative border-b border-section-yellow-foreground/20"
              >
                <div className="relative transition-colors duration-300 group-hover:bg-section-yellow-foreground/[0.06] px-2 md:px-6 py-10 md:py-14">
                  <div className="flex flex-col md:flex-row md:items-baseline gap-4 md:gap-10">
                    <CountUpNumber
                      value={i + 1}
                      className="font-display text-5xl md:text-7xl font-extrabold leading-none text-primary/30 transition-colors duration-300 group-hover:text-primary md:w-48 lg:w-56 shrink-0"
                    />
                    <div className="flex-1">
                      ...
                      <p className="mt-5 max-w-2xl text-sm md:text-base text-section-yellow-foreground/70 leading-relaxed">
                        {s.description}
                      </p>
                      {s.outcome && (
                        <div className="overflow-hidden max-h-0 opacity-0 transition-all duration-500 group-hover:max-h-24 group-hover:opacity-100 md:motion-safe:group-hover:mt-5">
                          <p className="label-eyebrow text-section-yellow-foreground/80 pt-5 md:pt-0">
          ...
          <div className="mt-20 flex justify-center">
            <button
              onClick={onCta}
              className="group inline-flex items-center gap-2 rounded-full bg-section-yellow-foreground px-8 py-4 font-bold text-section-yellow transition-all hover:gap-3 hover:bg-primary hover:text-primary-foreground"
            >
              {t("services.cta")}
